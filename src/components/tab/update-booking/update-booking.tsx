...
class UpdateBooking extends Component {
    state = { init: true, cancellationDone: false, modalMsg: '', refNo: '', modalMethod: null, showModal: false, mobile: '', mobileNumber: '', rowSelected: false, selectedRowKeys: [], selectedRows: [], mobileSearch: null, loadingAppointment: false, appointmentData: null, status: null };
    ...
    componentDidUpdate(props: any) {
        console.log("component did mount in update booking:", props.cancelTabChange);
    ...
    constructor(props?: any) {
        super(props);
        props = this.props;
        console.log("lanaguge:" + this.props.history)
